    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex-shrink-0 flex items-center gap-3">
                ...
                <span class="px-2.5 py-1 bg-blue-800/50 dark:bg-blue-900/40 rounded-lg text-xs font-semibold tracking-widest text-blue-200 border border-blue-700 dark:border-blue-800/50">ADMIN</span>
            </div>
