...
<div class="min-h-screen bg-gray-50 flex flex-col justify-between">
        ...
        <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div class="hidden md:flex gap-3 text-sm">
                    <a href="{{ route('donatur.dashboard') }}" class="px-3 py-1 rounded bg-[#2E75B6] font-medium transition">
                        Beranda
                    </a>
                    <a href="{{ route('donatur.riwayat') }}" class="px-3 py-1 rounded hover:bg-[#2E75B6]/50 transition">
                        Riwayat Donasi
                    </a>
                </div>
            </div>
    ...
    <div class="max-w-5xl w-full mx-auto px-4 py-12 flex-grow flex flex-col justify-start">
        ...
        <div class="flex md:hidden gap-2 mb-6 text-sm">
            <a href="{{ route('donatur.dashboard') }}" class="flex-1 text-center py-2 rounded-lg bg-[#1F4E79] text-white font-medium shadow-sm">
                Beranda
            </a>
            <a href="{{ route('donatur.riwayat') }}" class="flex-1 text-center py-2 rounded-lg bg-white border text-gray-700 hover:bg-gray-50">
                Riwayat Donasi
            </a>
            <a href="{{ route('pengaturan.notifikasi') }}" class="flex-1 text-center py-2 rounded-lg bg-white border text-gray-700 hover:bg-gray-50">
                Pengaturan
            </a>
        </div>

        {{-- Welcome Header --}}
        <div class="bg-gradient-to-r from-[#1F4E79] to-[#2E75B6] rounded-3xl p-8 text-white shadow-md mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto w-full">
            ...
            <a href="{{ route('donatur.riwayat') }}" class="group bg-white p-8 rounded-3xl border border-gray-200 shadow-sm hover:shadow-md hover:border-[#2E75B6] transition duration-200 text-left flex flex-col justify-between">
                <div>
                    ...
                    <h2 class="text-xl font-bold text-gray-950 group-hover:text-[#1F4E79] transition">Riwayat Donasi Saya</h2>
                ...
                <div class="mt-8 text-sm font-semibold text-[#1F4E79] flex items-center gap-1">
                    Buka Riwayat Donasi →
                </div>
            </a>

            {{-- Card 2: Salurkan Donasi Baru --}}
            <a href="{{ route('transparansi') }}" class="group bg-white p-8 rounded-3xl border border-gray-200 shadow-sm hover:shadow-md hover:border-[#2E75B6] transition duration-200 text-left flex flex-col justify-between">
                <div>
                    ...
                    <h2 class="text-xl font-bold text-gray-950 group-hover:text-green-600 transition">Salurkan Donasi Baru</h2>
                    <p class="text-sm text-gray-500 mt-2 leading-relaxed">
                ...
                <div class="mt-8 text-sm font-semibold text-green-600 flex items-center gap-1">
                    Donasi Sekarang →
                </div>
            </a>
        </div>
